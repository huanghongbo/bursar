...
<script type="text/javascript" src="${appPath}/bankcard/BankCardEdit.js"></script>
<div class="row">
	<div class="col-md-12">
		<form id="bankCardForm" class="form-horizontal" role="form" method="post"
			 action="${appPath}/bankcard/BankCardEdit.do">
			...
			<div class="form-group">
				<div class="col-sm-offset-2 col-sm-10">
					<button id="saveEditBtn" type="submit" class="btn btn-primary">保存</button>
					<button id="backToRead" type="button" class="btn btn-default">取消</button>
				</div>
			</div>
		</form>
	</div>
